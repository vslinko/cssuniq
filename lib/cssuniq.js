...
var parseCss = require('css/lib/parse');
...
function cssuniq(originalStyle, options) {
  var hash = 'c' + CRC32.str(originalStyle);
  var knownClasses = {};
  var node;
  ...
  var ast = parseCss(originalStyle);
  ...
  var uniqueStyle = stringifyCss(ast);
